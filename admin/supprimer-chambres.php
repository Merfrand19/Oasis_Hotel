...
session_start();
    ...
    if(!empty($_POST)) 
    {
        ...
        $db = Database::connect();
        $statement = $db->prepare("DELETE FROM chambres WHERE id = ?");
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            ?>
                            <h1 class="title-4">Supprimer la chambre
...
<form class="form" action="supprimer-chambres.php" role="form" method="post">
