<?php
    ...
    $categorieError=$numeroError=$decritError=$pieceError=$capaciteError=$prixError=$imageError="";
    if(!empty($_POST))
    {
       ...
       {
           $db = Database::connect();
           $statement = $db->prepare("INSERT INTO chambres (type, numero, image, categorie, Pieces, description, capacite, prix) values(?, ?, ?, ?, ?, ?, ?, ?)");
           $statement->execute(array($Type, $numero,$image,$categorie,$piece,$description,$capacite,$prix));
           Database::disconnect();
        ...
        <div class="page-content--bgf7">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <form class="form" action="ajout-chambres.php" role="form" method="post" enctype="multipart/form-data">
                               <?php
                                    if($type =='chambre'){
                                ?>   
                                    <div class="form-group">
                                        <label for="categorie">Catégorie:</label>
                                        <input type="text" class="form-control" id="categorie" name="categorie" placeholder="Catégorie de chambre" >
                                ...
                                ?>
                                        ...
                                        <input type="hidden" class="form-control" id="categorie" name="categorie" value="Salle de conférence" >
                                        <span class="text-danger"><?php  $categorieError?></span>
                                    </div>
                                <?php
                                      }
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="numero" name="numero" min="1" placeholder="Numéro de la pièce" value="<?php //echo $prix;?>">
                                    <span class="text-danger"><?php  echo $numeroError;?></span>
                                </div>
                                <div class="form-group">
                                    <label for="decrit">Description:</label>
                                    <input type="textarea" rows="5" cols="33" class="form-control" id="decrit" name="decrit" placeholder="Brève description de la chambre" >
                                ...
                                ?>   
                                    ...
                                    <input type="number" step="1" class="form-control" id="piece" name="piece" min="1" placeholder="Nombre de pièces de la chambre" value="<?php //echo $prix;?>">
                                ...
                                ?>
                                        <div class="form-group">
                                    <input type="hidden" step="1" class="form-control" id="piece" name="piece" min="1" value="1">
                                    <span class="text-danger"><?php  echo $pieceError;?></span>
                                </div>
                                <?php
                                      }
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="1" class="form-control" id="capacité" min="1" name="capacite" placeholder="Nombre de personnes que peut contenir la chambre" value="<?php //echo $prix;?>">
