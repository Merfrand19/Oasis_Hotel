                ...
                <div class="container">
                    <div class="row">
                        ...
                        <?php
                            ...
                            ?>
                            <h1 class="title-4">Voir 
                                <span>chambre <?= $item['numero'] ?></span>
                            </h1>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                            <h3 class="title-2 m-b-40"><?=$chambre['categorie']?></h3>
                            <div class="text-primary"><?=$chambre['description']?></div><br>
                            <ul>
                                <li>Nombre de pièces: <?=$chambre['Pieces']?></li>
                                <li>Nombre maximal de personnes: <?=$chambre['capacite']?></li>
                                <li>Numéro:  <?=$chambre['numero']?></li>
                                <li>Prix: <?=$chambre['prix']?> F cfa</li>
                                <?php 
                                     if($chambre['disponible']=='oui'){ echo '<li">Status: <span class="text-primary">Disponible</span></li>'; } else{ echo '<li>Status: <span class="text-warning">Occupé</span></li>';}
                                ?>
                            </ul>
                            </div>
                            ...
                            <!-- <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">Image</h3>
                                        <img src="../images/<?//=$chambre['Image']?>" alt="">
                                    </div>
                                </div>
                            </div>
            ...
            <section class="p-t-60 p-b-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2023 <a href="#">Oasis Hotel</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
